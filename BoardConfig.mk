...
# Assert
TARGET_OTA_ASSERT_DEVICE := X-music Ⅲ

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 8085504 # This is the maximum known partition size, but it can be higher, so we just omit it
